		...
		if(!empty($_FILES['filefoto']['name']))
		{
			if ($this->upload->do_upload('filefoto'))
			{
					...
					if (empty($password) && empty($konfirm_password)) {
						$this->M_pengguna->update_pengguna_tanpa_pass($kode,$nama,$jenkel,$username,$password,$level,$gambar);
						echo $this->session->set_flashdata('msg','info');
						 ...
						 echo $this->session->set_flashdata('msg','error');
						   ...
						   $this->M_pengguna->update_pengguna($kode,$nama,$jenkel,$username,$password,$level,$gambar);
						echo $this->session->set_flashdata('msg','info');
						   redirect('pengguna');
					   }
